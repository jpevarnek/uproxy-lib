...
//    console.log('encoded target: '+arraybuffers.arrayBufferToHexString(target));
  ...
  it('decode(ca.0.1.0.5c...0.74)==0.1.0.5c...43.3', function() {
    ...
    var decoder=new arithmetic.Decoder(makeUniformProbabilities());
    var decoded=decoder.decode(encoded);
//    console.log('decoded target: '+arraybuffers.arrayBufferToHexString(target));
//    console.log('decoded result: '+arraybuffers.arrayBufferToHexString(decoded));
